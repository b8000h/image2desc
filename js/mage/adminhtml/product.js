...
Product.Gallery.prototype = {
    ...
    updateImage : function(file) {
        ...
        this.images[index].inserted = (this.getFileElement(file,
                'cell-inserted input').checked ? 1 : 0);
        this.getElement('save').value = Object.toJSON(this.images);
    ...
    updateVisualisation : function(file) {
        ...
        this.getFileElement(file, 'cell-inserted input').checked = (image.inserted == 1);
        $H(this.imageTypes)
                .each(
                        function(pair) {
